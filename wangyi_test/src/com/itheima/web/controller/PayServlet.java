...
public class PayServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String pd_FrpId = request.getParameter("pd_FrpId");//支付通道：银行
		
		String p0_Cmd = "Buy";
		String p1_MerId = "10001126856";//商户编号  测试账户
		...
		String p8_Url = "http://localhost:8080/"+request.getContextPath()+"/pay/PayResultServlet";
		String p9_SAF = "1";
		String pa_MP = "test";
